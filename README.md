...
NeckBeardCryptoTips - version 0.1

---------
NeckBeardCryptoTips Masternode Setup
---------
...
d.	To see if the blocks are syncing “watch NeckBeardCryptoTipsd_mn1.sh getinfo”
...
To add more NBCT MNs to a existing server setup with the setup.sh script before just restart the script and type “n” when asked if you want to install the dependencies at the beginning. After that just follow the steps from before in the interactive script.
